...
from src.dataset.multi_dataset import BrainDataset
from src.model.CLIP import M3DCLIP, M3DCLIPConfig
...
class ModelArguments:
    ...
    language_model_name_or_path: str = field(default="../pretrained_model/bert_base_uncased/")
    # "src/pretrained_model/bert_base_uncased"
...
class DataArguments:
    ...
    # caption data
    report_path: str =field(default="../../data/report.csv", metadata={"help": "Root directory for all data."})
...
def main():
    ...
    model = torch.nn.DataParallel(model, device_ids=[2,3,6,7])
    ...
    train_dataset = BrainDataset(data_args, tokenizer)
